...
还没有劈好。一位火工道人正愁眉苦脸地坐在那里，看着那堆柴。墙上挂
着一块牌子(paizi)，墙边扔着一把柴刀。
LONG
	);
...
int do_kan(string arg)
{
	...
	if (random(3)<2) {
		...
		message_vision("结果$N用力过猛，柴刀一下子嵌在了柴里。$N用尽吃奶的力气把柴刀拔出来，又摔了个大跟斗。\n",me);
	}
	else {
		...
		ob->set_amount(10);
		ob->move(me);
		message_vision("结果木柴应声被劈成两半。火工道人笑着对$N说，你工作的不错呀，这是你的酬劳。\n",me);
