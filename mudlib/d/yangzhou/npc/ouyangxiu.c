      ...
      if( ob->query("want_lihun")==me->query("id") )
        {
         ...
         me->delete("marry");
         me->delete("marry_member");
         me->delete("want_marry");
         me->delete("want_lihun");
         ob->delete("marry");
         ob->delete("marry_member");
...
if( !objectp(ob = find_player(arg)))
     ...
     if(file_size(me->query("marry_member")+".o")>0) 
        {
      ...
      if( ob->query("want_marry")==me->query("id") )
        {
         ...
         ob->set("marry_member",me->query_save_file());
         me->set("marry",arg);
         me->set("marry_member",ob->query_save_file());
