...
*/
        ...
        message("vision", me->name() + "边读书边把腰身扭来扭去。\n", environment(me), me);
          ...
          if( (int)me->query("gin") < 15 ) {
           ...
           if ( me->query_skill("pixie-jianfa", 1) > 84) force_lost = 75;
	else
           if ( me->query_skill("pixie-jianfa", 1) > 74) force_lost = 50;
         else force_lost = 25;
        ...
        if( (int)me->query("combat_exp") < (int)pxlevel*pxlevel*pxlevel/10 ) {
          ...
          if( me->query_skill("pixie-jianfa", 1) > 59)
      ...
      if( me->query_skill("pixie-jianfa", 1) > 99){
        ...
        if( !me->query_skill("pixie-jianfa", 1) ) {
                me->set_skill("pixie-jianfa", 0);
write("                   《葵花宝典》阅读指南\n"
"\n    恭喜你开始研习武林第一功夫－－－－辟邪剑法！\n"
"注意事项：\n"
...
"         祝你早日成为武林第一高手，称霸天下！\n");
         ...
         me->improve_skill("pixie-jianfa", (int)me->query_skill("literate", 1)/3+1);
        write("你研读《葵花宝典》，颇有心得。\n");
        return 1;
}
