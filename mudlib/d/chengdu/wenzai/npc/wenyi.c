...
void create()
{
	...
	set("chat_msg",({
       ...
       set_temp("shoupa",1);
       setup();
	carry_object("/d/chengdu/npc/obj/necklace")->wear();
	carry_object("/d/chengdu/npc/obj/pink_cloth")->wear();
	carry_object("/d/chengdu/npc/obj/flower_shoe")->wear();
	carry_object("/d/chengdu/npc/obj/goldring")->wear();
}
...
string inquiry_shoupa()
{
 ...
 {  message_vision("温仪又说道：这位"+ RANK_D->query_respect(me)+"，我已经托人帮我带了，就不麻烦你了。\n",me);
   ...
   message_vision("温仪说道：这位"+ RANK_D->query_respect(me)+"，这是我和郎君的信物，看见它，他就知道我的心意了。\n" , me);
	obn=new(__DIR__"obj/shoupa");
   obn->move(me);
   set_temp("shoupa",0);
   return "请你一定交到他的手上，他就在城西的山洞中。说完，温仪给你一张绣花的手帕。\n";
}
