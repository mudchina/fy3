...
//    ]));
      ...
      if((gt[LT_HOUR] <14 )&&(gt[LT_HOUR] >=11)) 
      {
	  set("exits", ([ /* sizeof() == 8 */
		"east" : __DIR__"east1",
		"west" : __DIR__"west1",
		"north": __DIR__"qianzhen",
	  ...
	  set("exits", ([ /* sizeof() == 8 */
		...
		"south": __DIR__"south1",
       	"northeast": __DIR__"nteast1",
            "northwest": __DIR__"ntwest1",
            "southeast": __DIR__"qianzhen",
            "southwest": __DIR__"stwest1",
	  ]));
      }
      else if((gt[LT_HOUR] <2 )||(gt[LT_HOUR] >=23)) 
      {
	  set("exits", ([ /* sizeof() == 8 */
		"east" : __DIR__"east1",
		"west" : __DIR__"west1",
		"north": __DIR__"north1",
		"south": __DIR__"qianzhen",
       	"northeast": __DIR__"nteast1",
            "northwest": __DIR__"ntwest1",
            "southeast": __DIR__"steast1",
            "southwest": __DIR__"stwest1",
