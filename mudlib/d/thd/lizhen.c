...
//    ]));
      ...
      if((gt[LT_HOUR] <8 )&&(gt[LT_HOUR] >=5)) 
      {
	  set("exits", ([ /* sizeof() == 8 */
		"east" : __DIR__"east1",
		"west" : __DIR__"west1",
		"north": __DIR__"chuzhen",
