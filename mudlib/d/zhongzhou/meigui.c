...
int do_broadcast(string arg)
{
        ...
        if (type == "marry") {
mesg = me->name() + "现在在大观园茶楼玫瑰厅举行订婚酒宴了  !!!\n";
        } else if (type == "birthday") {
mesg = me->name() + "现在在大观园茶楼玫瑰厅举行生辰寿宴了  !!!\n";
        } else if (type == "player") {
mesg = me->name() + "现在在大观园茶楼玫瑰厅宴请各路英雄豪杰  !!!\n";
       }
