...
*/	
	hp_status = ob->query_entire_dbase();
		...
		me->set("max_kee",    hp_status["max_qi"]);
		me->set("eff_kee",    hp_status["eff_qi"]);
		me->set("kee",        hp_status["qi"]);
		me->set("max_gin",  hp_status["max_jing"]);
		me->set("eff_gin",  hp_status["eff_jing"]);
		me->set("gin",      hp_status["jing"]);
