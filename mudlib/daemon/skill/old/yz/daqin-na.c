...
{
	return CLASS_D("daoshi")+"/daqin-na/"+action;
}
void skill_improved(object me)
{
	if(me->query_skill("daqin-na",1)==20)
        tell_object(me,HIC"你领悟了「七星掌」第一式！(qixing，加力不大于20)\n"NOR);
	if(me->query_skill("daqin-na",1)==40)
	tell_object(me,HIC"你领悟了「七星掌」第二式！(qixing，加力21至40)\n"NOR);
	if(me->query_skill("daqin-na",1)==60)
	tell_object(me,HIC"你领悟了「七星掌」第三式！(qixing，加力41到60)\n"NOR);
	if(me->query_skill("daqin-na",1)==80)
	tell_object(me,HIC"你领悟了「七星掌」第四式！(qixing，加力大于60)\n"NOR);
}
