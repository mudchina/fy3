// miejue-fu.c 灭绝刀 by ksusan 7/27/97 10:30
...
//int valid_combine(string combo) { return combo=="wugong-zuifa"; }

int valid_learn(object me)
{
	if ((int)me->query("max_force") < 100)
		return notify_fail("你的内力不够。\n");
	if ((int)me->query_skill("wuxian-steps", 1) < 20)
		return notify_fail("你的五仙玲珑步火候太浅。\n");
	return 1;
}
...
{
        int i, level;
	level   = (int) me->query_skill("miejue-dao",1);
...
int practice_skill(object me)
{
	...
	if ((int)me->query("kee") < 50)
		return notify_fail("你的体力不够练灭绝刀法。\n");
