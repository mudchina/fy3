...
//    ]));
      ...
      if((gt[LT_HOUR] <23 )&&(gt[LT_HOUR] >=20)) 
      {
	  set("exits", ([ /* sizeof() == 8 */
		"east" : __DIR__"east1",
		"west" : __DIR__"west1",
		"north": __DIR__"zhenzhen",
