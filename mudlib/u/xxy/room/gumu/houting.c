...
的灯光下，你发现墙上悬挂着一幅画(picture)，似乎是一幅人物的肖像。
在厅的中央，摆放着几具棺材(coffin)，其中只有一具棺材的棺板没有合
上，棺材中好象空空如也。
LONG
	);
	...
	set("item_desc", ([
        "picture": "画中是一个中年道士的背影，看不出什么相貌，画中人一手指天，画角题着‘"+MAG"活死人像"NOR+"’几个大字。\n",
...
int do_tang(string arg)
{
	...
	if (random(21)>10) 
		ob=new("/d/taohua/obj/jiuyin2");
	else 
		ob=new("/d/taohua/obj/jiuyin1");	
	ob->move(me);
	add("getbook",-1);
	}
	else {
