...
void create()
{
	...
	set("chat_msg_combat", ({
		...
		(: command("unwield cool_sword") :),
		(: command("unwield cool_sword") :),
		(: command("unwield cool_sword") :),
		(: command("unwield cool_sword") :),
		(: command("wield cool_sword") :),
		(: command("wield cool_sword") :),
		(: command("wield cool_sword") :),
		(: command("wield cool_sword") :),
	...
	setup();
	carry_object("/u/xxy/obj/ring")->wear();
	carry_object("/u/xxy/obj/crystal")->wear();
	carry_object("/u/xxy/obj/shouzhuo")->wear();
	carry_object("/u/xxy/obj/majia")->wear();
	carry_object("/u/xxy/obj/baojia")->wear();
	carry_object("/u/xxy/obj/cool_sword")->wield();
	carry_object("/u/xxy/obj/yupei")->wear();
	carry_object("/u/xxy/obj/bishou")->wield();
	carry_object("/u/xxy/obj/gun")->wield();
...
void relay_emote(object ob, string verb)
{
	...
	if ( (string) ob -> query ("gender") == "男性"||(string) ob -> query ("id") == "xxy" )
	{
	command ("chat 太古快来啊，"+ ob->query("name") + "想要非礼我！\n") ;
   ...
   switch(random(50))
   {
    ...
    case 8:
    command("cry");
   command ("chat 太古快来啊，"+ ob->query("name") + "想要羞辱我！\n") ;
...
varargs void drool(string msg, string who)
{
    ...
    {
        case 1:	this_object()->set("killer","乞丐");break;
	case 2:	this_object()->set("killer","郎中");break;
	case 3:	this_object()->set("killer","小孩子");break;
	case 4:	this_object()->set("killer","小宝");break;
	case 5:	this_object()->set("killer","郑板桥");break;
	case 6:	this_object()->set("killer","欧阳修");break;
	case 7:	this_object()->set("killer","李凌");break;
	case 8:	this_object()->set("killer","打手");break;
	case 9:	this_object()->set("killer","小贩");break;
	case 10:this_object()->set("killer","书生");break;
	case 11:this_object()->set("killer","崔盈盈");break;
	}
    }
	...
	if( (strsrch(msg, "kiss") >= 0)|| (strsrch(msg, "love") >= 0)|| (strsrch(msg, "吻") >= 0)
		...
		if( sscanf(msg, "%*sclub%s", msg) == 2 ) msg = "club" + msg;
		if( sscanf(msg, "%*srob%s", msg) == 2 ) msg = "rob" + msg;
		if( sscanf(msg, "%*srose%s", msg) == 2 ) msg = "rose" + msg;
		...
		case 7:command ("chat 太古快来啊，"+ who + "想要羞辱我！\n") ;
		...
		case 15:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
	                case 16:command ("chat 太古快来啊，"+ who + "欺负我！\n") ; break;
		}
		return;
	}
	...
	{	
		...
		case 11:command("chat* 李凌忽然大声说：打倒臭泥潭，打倒太古！\n"); break;
		case 12:command("chat* 李凌揉了揉哭红的眼睛，跺脚道： "+who+",我恨死你了！\n"); break;
		case 13:command ("chat 太古快来啊，"+ who + "又想要羞辱我！\n") ; break;
		}
	}
	...
	{	
		...
		case 11:command("chat* 一朵红云飞上了李凌的面颊.\n");break;
		}
		return;
        }
	}
	switch(random(80)) {
        ...
        case 26:	command ("chat 太古快来啊，"+ who + "又来欺侮我！\n") ; break;
		...
		case 59:command("chat* 李凌笑嘻嘻的看着"+who+"\n");break;
		case 60:command("chat 为什么呢?\n");break;
		case 61:command("chat 你是在说我吗？\n"); break;
		case 62:command("chat 无聊!\n");break;
		case 63:command("chat* 一朵红云飞上了李凌的面颊.\n");break;
		case 64:command("chat* 李凌是个自恋狂。\n");break;
		default:
	...
	{	
		...
		switch(random(250)) {
			...
			case 33: command("chat* 李凌嘻嘻地笑了几声.\n");break;
			...
			case 59:command("chat* 李凌忽然大声说：打倒臭泥潭，打倒太古！\n"); break;
...
int do_tell ( string arg )
{
   ...
   if( sscanf(arg, "liling xxy send me %s", dir2)==1 ) {
   ...
   if( sscanf(arg, "liling %s", dir)==1 ) {
		...
		{
		command("tell "+ob->query("id")+" 你尽管自个儿爱吧。我就对太古还有点儿兴趣。");
...
void die()
{
	...
	ob = new("/u/xxyobj/shouzhuo");
	ob->move(environment(this_object()));
	ob = new("/u/xxyobj/yupei");
	ob->move(environment(this_object()));
	ob = new("/u/xxyobj/crystal");
	ob->move(environment(this_object()));
	ob= new("/u/xxyobj/ring");
	ob->move(environment(this_object()));
	ob= new("/u/xxyobj/majia");
	ob->move(environment(this_object()));
	ob= new("/u/xxyobj/baojia");
	ob->move(environment(this_object()));
	ob= new("/u/xxyobj/cool_sword");
	ob->move(environment(this_object()));
...
int accept_object(object me, object ob)
{
	...
	{
	message_vision("\n$N猛的扬起头，用惊喜的眼光看着$n，说：\n"
	+"咦，这不是太古送我的戒指吗，是他要你带来的么? 真谢谢你啊...\n",this_object(),me);
	}
	if ((string)ob->query("name")==HIW "水晶鞋" NOR) 
	{
	message_vision("\n$N猛的扬起头，用惊喜的眼光看着$n，说：\n"
	+"咦，这不是太古送我的吗水晶鞋吗，是他要你带来的么? 真谢谢你啊...\n",this_object(),me);
	}
	...
	{
	message_vision("\n$N缓缓地摇了摇头，柔声说道:不是太古送我的,我不要.\n"
	+"说罢垂下头来，咬了咬牙,幽幽嗔道：死太古，臭太古，为什么还不回来呢?\n",this_object());
	return 0;
	}
}
...
int do_faint(object me)
{
	...
	message_vision(HIC "$N对$n说道：有人请我来打晕你，对不起啊。。。\n"
        ...
        dest->unconcious();
	this_object()->move("/u/xxy/workroom");
 	return 1;
}
...
int do_kill(object me, object dest)
{
	...
	{
		message_vision(HIR "$N对$n说道：太古要我来杀你，对不起啊。。。\n"
			+RANK_D->query_rude(dest)+"，你就认命吧！\n" NOR, me, dest);
			if(wizardp(dest))		
	                { 
			dest->set("immortal",0);
...
int do_back(object me)
{
	...
	me->move("/u/xxy/workroom");
	message("vision", "李凌走了进来，幽幽道：唉，太古真不乖，害得我又杀了人。\n", 
		environment(), me );
	me->set_leader(0);
	set("chat_chance", 3);
	set("chat_msg", ({
